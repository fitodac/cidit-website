            ...
            <div className="tp-offcanvas-top d-flex align-items-center justify-content-between">
                <div className="tp-offcanvas-logo">
                    <a href="index-digital-agency.html">
                        <img className="logo-1" data-width="120" src="assets/img/logo/logo-black.png" alt="" />
                        <img className="logo-2" data-width="120" src="assets/img/logo/logo-white.png" alt="" />
                    </a>
                </div>
                    ...
                    <div className="row gx-2">
                        <div className="col-md-3 col-3">
                            <div className="tp-offcanvas-gallery-img fix">
                                <a className="popup-image" href="assets/img/offcanvas/offcanvas-1.jpg">
                        ...
                        <div className="col-md-3 col-3">
                            <div className="tp-offcanvas-gallery-img fix">
                                <a className="popup-image" href="assets/img/offcanvas/offcanvas-2.jpg">
                        ...
                        <div className="col-md-3 col-3">
                            <div className="tp-offcanvas-gallery-img fix">
                                <a className="popup-image" href="assets/img/offcanvas/offcanvas-3.jpg">
                        ...
                        <div className="col-md-3 col-3">
                            <div className="tp-offcanvas-gallery-img fix">
                                <a className="popup-image" href="assets/img/offcanvas/offcanvas-4.jpg">
                                    <img src="assets/img/offcanvas/offcanvas-4.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>

export default function Testimonials() {
  return (
    <div className="ma-testimonial-ptb pb-200">
                    ...
                    <div className="col-lg-8">
                      <div className="ma-testimonial-wrap">
                        <div className="ma-testimonial-content">
                          <p>
                            Partnering this agency has a transformative experience
                            for our business. From the very first consultation
                            their showcased an exceptional understanding of our
                            brand vision
                          </p>
                        </div>

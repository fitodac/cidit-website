...
export default function Hero() {
	return (
		<>
				...
				<div className="container container-1530">
					<div className="row">
						<div className="col-xl-7">
							<div
								className="ma-hero-title-box tp_fade_anim mt-11! lg:h-100"
								data-delay=".3"
							>
			...
			<div className="sa-hero-bottom-wrap border-b border-gray-200 bg-white py-4 relative z-10">
				<div className="container container-1510">
					<div className="row">
						<div className="col-md-6">
							<div className="sa-hero-social flex gap-3!">
								<a
									href={String(data("facebook"))}
									target="_blank"
